        ...
        redirect: function (options) {
            ...
            */
            ...
            if (hasIos && /iP(hone|ad|od)/.test(navigator.userAgent)) {
                ...
                if(intent.developer){
                    window.location = 'https://play.google.com/store/apps/dev?id=9086822210784570386';
                }
                ...
                if (anchor.click) {
                    ...
                    window.location.replace("http://stackoverflow.com");//window.location = intentUrl;
                }

            } else {
                window.location="https://redboxgamestudios.com/";
            }
